...
function modal(){  //to activate the modal
    document.getElementById("modal").style.display="block";
}


// document.getElementById("modalclose").onclick=function(e){document.getElementById("modal").style.display="none";}


document.getElementById("not1").addEventListener("click",(e)=>{
